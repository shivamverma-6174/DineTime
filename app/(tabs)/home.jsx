  ...
  return (
    <SafeAreaView
      style={[
        ...
        Platform.OS == "android" && { paddingBottom: 45 },
      ]}
    >
      <View className="flex items-center pt-2">
        <View className="bg-[#5f5f5f] w-11/12 rounded-lg shadow-lg justify-between items-center flex flex-row p-2">
          <View className="flex flex-row">
            <Text
              className={`text-base h-10 mt-0.5
                pt-[${Platform.OS == "ios" ? "pt-[8px]" : "pt-1"}]
      ...
      <ScrollView stickyHeaderIndices={[0]}>
        <ImageBackground
          resizeMode="cover"
          className=" w-full bg-[#2b2b2b] h-52 items-center justify-center"
          source={banner}
        >
          <BlurView
